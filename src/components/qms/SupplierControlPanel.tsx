    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-[300px_minmax(0,1fr)]">
      ...
      <div className="panel-raised p-4 lg:sticky lg:top-4 lg:self-start">
        ...
        <div className="mt-3 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
          <Block icon={FileCheck2} title="Required documents" items={active.requiredDocuments} accent="#6d3bd4" />
          <Block icon={ClipboardCheck} title="Receiving checks" items={active.receivingChecks} accent="#15803d" />
          <Block icon={AlertTriangle} title="Quality risks" items={active.qualityRisks} accent="#b8860b" />
